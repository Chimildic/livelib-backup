const STATUS = {
    starting: [
        ...
        'Теперь осталось только не спалить сервер... 🤞',
    ],
    isNotLastPage: [
        ...
        'Ваша библиотека весит больше чем ноутбук. Серьёзно, проверьте 🔥',
        'Парсер устал. А вы всё читаете? Может, чаю попейте? ☕',
        'Если продолжите в том же духе, я начну читать лекцию о вреде чтения 🎓',
        'Кажется, вы читаете быстрее, чем я могу генерировать эти сообщения...',
    ],
    creatingFile: [
